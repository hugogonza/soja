...
privileged aspect ExamenGeneralOrinasCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void ExamenGeneralOrinasCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        if (columnName.equals("id")) {
            ...
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_fecha", null, "Fecha", locale), "fecha", Calendar.class.getName(), 100);
        }
        else if (columnName.equals("Color")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_color", null, "Color", locale), "Color", ColorOrina.class.getName(), 100);
        }
        else if (columnName.equals("Aspecto")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_aspecto", null, "Aspecto", locale), "Aspecto", AspectoOrina.class.getName(), 100);
        }
        else if (columnName.equals("ph")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_ph", null, "Ph", locale), "ph", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("densidad")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_densidad", null, "Densidad", locale), "densidad", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("proteinas")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_proteinas", null, "Proteinas", locale), "proteinas", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("hemoglobina")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_hemoglobina", null, "Hemoglobina", locale), "hemoglobina", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("glucosa")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_glucosa", null, "Glucosa", locale), "glucosa", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("urobilinogeno")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_urobilinogeno", null, "Urobilinogeno", locale), "urobilinogeno", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("bilirrubina")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_bilirrubina", null, "Bilirrubina", locale), "bilirrubina", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("cuerpos_cetonicos")) {
        ...
        else if (columnName.equals("celulas_epiteliales_b")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_celulas_epiteliales_b", null, "Celulas _ Epiteliales _ B", locale), "celulas_epiteliales_b", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("leucocitos_a")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_leucocitos_a", null, "Leucocitos _ A", locale), "leucocitos_a", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("leucocitos_b")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_leucocitos_b", null, "Leucocitos _ B", locale), "leucocitos_b", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("eritrocitos_a")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_eritrocitos_a", null, "Eritrocitos _ A", locale), "eritrocitos_a", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("eritrocitos_b")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_eritrocitos_b", null, "Eritrocitos _ B", locale), "eritrocitos_b", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("cilindros_hialinos_a")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_cilindros_hialinos_a", null, "Cilindros _ Hialinos _ A", locale), "cilindros_hialinos_a", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("cilindros_hialinos_b")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_cilindros_hialinos_b", null, "Cilindros _ Hialinos _ B", locale), "cilindros_hialinos_b", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("cilindros_epiteliales_a")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_cilindros_epiteliales_a", null, "Cilindros _ Epiteliales _ A", locale), "cilindros_epiteliales_a", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("cilindros_epiteliales_b")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_cilindros_epiteliales_b", null, "Cilindros _ Epiteliales _ B", locale), "cilindros_epiteliales_b", BigDecimal.class.getName(), 100);
        }
        else if (columnName.equals("tipo_cristales")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_tipo_cristales", null, "Tipo _ Cristales", locale), "tipo_cristales", TipoCristales.class.getName(), 100);
        }
        else if (columnName.equals("cristales_cantidad")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_cristales_cantidad", null, "Cristales _ Cantidad", locale), "cristales_cantidad", CantidadCristales.class.getName(), 100);
        }
        else if (columnName.equals("levaduras")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_levaduras", null, "Levaduras", locale), "levaduras", HayEnOrina.class.getName(), 100);
        }
        else if (columnName.equals("bacterias")) {
            builder.addColumn(getMessageSource().getMessage("label_examengeneralorina_bacterias", null, "Bacterias", locale), "bacterias", HayBacterias.class.getName(), 100);
        }
        }
